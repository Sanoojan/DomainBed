...
if __name__ == "__main__":
    ...
    if args.algorithm in ('CorrespondenceSelfCross' ,'DeitSmallDtest','CrossImageVIT','CrossImageVITSepCE','CrossImageVITDeit','CrossImageVITSInf','CrossImageVITSepCE_SINF') : # Queue computations 
