...
if __name__ == "__main__":
    ...
    if args.algorithm in ('CorrespondenceSelfCross' ,'DeitSmallDtest','CrossImageVIT','CrossImageVITSepCE','CrossImageVITSInf','CrossImageVITSepCE_SINF') : # Queue computations 
